...
// =============================---==============
#ifndef __EulerSolver_FV_Variables_CLASS_HEADER__
#define __EulerSolver_FV_Variables_CLASS_HEADER__
 ...
 * specification file
 **/
struct Euler::AbstractEulerSolver_FV::VariableMetrics {
 ...
 **/
class Euler::AbstractEulerSolver_FV::VariableShortcuts : public Euler::AbstractEulerSolver_FV::VariableMetrics {
public:
 ...
 **/
class Euler::AbstractEulerSolver_FV::VariableMultiplicities : public Euler::AbstractEulerSolver_FV::VariableMetrics {
public:
  /// positions of fields inside the unknown vector (solution vector) Q
 ...
 *
 **/
class Euler::AbstractEulerSolver_FV::VariableNames : public Euler::AbstractEulerSolver_FV::VariableMetrics {
public:
 ...
 * 
 *    void somewhere() {
 *       using namespace Euler::EulerSolver_FV_Variables::shortcuts;
 *       Q[foo] = 17;
 *    }
 *
 * instead of
 * 
 *    void somewhere() {
 *       Euler::AbstractEulerSolver_FV::VariableNames q;
 *       Q[q.foo] = 17;
 *    }
 *
 **/
namespace Euler {
  namespace EulerSolver_FV_Variables {
    namespace shortcuts {
      constexpr int rho = 0;
      constexpr int j = 1;
      constexpr int E = 4;
  ...
  } // end of namespace Euler::EulerSolver_FV_Variables 
...
class Euler::AbstractEulerSolver_FV::ReadOnlyVariables : public Euler::AbstractEulerSolver_FV::VariableMetrics {
  private:
...
class Euler::AbstractEulerSolver_FV::Variables : public Euler::AbstractEulerSolver_FV::VariableMetrics{
  private:
    double* const _Q;
  public:
    static constexpr int SizeVariables  = 5;
...
class Euler::AbstractEulerSolver_FV::Fluxes : public Euler::AbstractEulerSolver_FV::VariableMetrics {
  private:
    double** const _F;
  public:
...
// Global Observables
//
class Euler::AbstractEulerSolver_FV::ReadOnlyGlobalObservables {
  private:
...
class Euler::AbstractEulerSolver_FV::GlobalObservables {
  private:
