...
//   www.exahype.eu
// ========================
#ifndef __AbstractEulerSolver_FV_CLASS_HEADER__
#define __AbstractEulerSolver_FV_CLASS_HEADER__
...
namespace Euler{
  class AbstractEulerSolver_FV;
  class EulerSolver_FV;
}

class Euler::AbstractEulerSolver_FV : public exahype::solvers::FiniteVolumesSolver {
  public:
    ...
    static constexpr int PatchSize                 = 12;
...
#endif // __AbstractEulerSolver_FV_CLASS_HEADER__